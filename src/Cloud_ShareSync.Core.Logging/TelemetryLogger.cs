...
namespace Cloud_ShareSync.Core.Logging {
    ...
    public class TelemetryLogger : CloudShareSyncILogger {
        ...
        public TelemetryLogger( string serviceName, string[] sources ) : this( serviceName ) {
            Hierarchy? hierarchy = _loggerRepository as Hierarchy;
        ...
        /// <summary>
        /// Converts the <see cref="_loggerRepository"/> into a <see cref="Hierarchy"/>.
        ...
        /// then this converts the <see cref="_loggerRepository"/> into a <see cref="Hierarchy"/> and adds a
        ...
        /// <summary>
        /// Converts the <see cref="_loggerRepository"/> into a <see cref="Hierarchy"/> and sets the 
