...
namespace Cloud_ShareSync.GUI.Views {
    public partial class ConfigureWindow : Window {
        ...
        private readonly TabControl _tabWindow = new( ) {
            TabStripPlacement = Dock.Left
        };

        private readonly TabControl _tabLogWindow = new( ) {
        ...
        private void ConfigureLogTabContent( ) {
            _tabLogWindow.Items = new List<TabItem>( ) {
                _defaultLogging,
                _telemetryLogging,
                _consoleLogging
            };
            _logging.Content = _tabLogWindow;
        }

        private void ConfigureMainTabContent( ) {
            _tabWindow.Items = new List<TabItem>( ) {
                _main,
                _sync,
                _database,
                _logging,
        ...
        internal void UpdateConfigSection( ICloudShareSyncConfig configSection ) {
            ...
            _ = CompleteConfigBuilder.ValidateAndAssignDefaults( config, false );
