...
namespace Cloud_ShareSync.Core.Configuration.ManagedActions {
    public class CompleteConfigBuilder {
        ...
        public IConfigurationSection GetSyncConfigSection( ) => _configuration!.GetRequiredSection( "Sync" );
        public IConfigurationSection GetB2ConfigSection( ) => _configuration!.GetRequiredSection( "BackBlaze" );
        public IConfigurationSection GetDatabaseConfigSection( ) => _configuration!.GetRequiredSection( "Database" );
